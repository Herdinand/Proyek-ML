...
# Path ke folder dataset hasil preprocessing
...
for filename in os.listdir(dataset_folder):
    if filename.lower().endswith(('.png', '.jpg', '.jpeg')):
        ...
        img = np.array(img) / 255.0  # Normalisasi pixel
        img = img.flatten()  # Flatten jadi 1D vector
...
# Step 4: Train KNN
k = 3  # Misal kita pakai 3 tetangga terdekat
